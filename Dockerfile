...
# Uncomment after running `rails new`:
...
# final destination at /srv/demo:
COPY --from=builder --chown=nobody:nogroup ${APP_PATH} /srv/demo

# Set the container user to 'nobody':
USER nobody

# Set the RAILS and PORT default values:
ENV HOME=/srv/demo RAILS_ENV=production PORT=3000
